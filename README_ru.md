...
-   **Панель быстрых пресетов:** Ряд кнопок на самом виджете с 3 последними использованными пресетами для переключения в один клик.
-   **Недавние пресеты:** Быстрый доступ к последним использованным конфигурациям прямо из меню в трее.
